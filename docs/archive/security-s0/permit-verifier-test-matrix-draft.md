...
> **ARCHIVED DRAFT:** matrix นี้เขียนก่อน strict permit verifier ถูก implement และ test
> สถานะ `SKELETON/BLOCKED` ด้านล่างเป็น historical context ไม่ใช่สถานะ source ปัจจุบัน ดู
